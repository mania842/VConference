...
public class ChatRoomActivity extends Activity {
			...
			public void onSuccess(final ArrayList<QBDialog> dialogs, Bundle args) {
				...
				QBUsers.getUsersByIDs(usersIDs, requestBuilder, new QBEntityCallbackImpl<ArrayList<QBUser>>() {
					...
					public void onSuccess(ArrayList<QBUser> users, Bundle params) {
						...
						// Save users
						//
						((VideoConferenceApplication) getApplication()).setDialogsUsers(users);
	...
	void buildListView(List<QBDialog> dialogs) {
		final ChatRoomAdapter adapter = new ChatRoomAdapter(dialogs, ChatRoomActivity.this);
		...
		dialogsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				// Open chat activity
				//
				ChatActivity.start(ChatRoomActivity.this, bundle);
			}
		});
	}
